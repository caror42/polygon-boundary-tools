...
point = [-79.27, 35.911696] #should return false
#point = [-79.0594942, 35.911696] #should return true
json = '''{
    "type":"Feature",
    "geometry":{
       "type":"Polygon",
...
if point_in_poly(point, coor[0])
   puts "Point is inside polygon"
else
   puts "Point is outside polygon"
end
